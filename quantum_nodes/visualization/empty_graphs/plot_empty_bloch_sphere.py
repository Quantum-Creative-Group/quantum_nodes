...
def plotEmptyBlochSphere():   
    ...
    bm = bmesh.new()
    bmesh.ops.create_uvsphere(bm, u_segments = 32, v_segments = 16, radius = 2)
    ...
    bm = bmesh.new()
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=12, radius1=0.01, radius2=0.01, depth=3.948)
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.983, radius2=1.983, depth=0.01)
    ...
    bm = bmesh.new()
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.915, radius2=1.915, depth=0.01)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, 1.)))
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.915, radius2=1.915, depth=0.01)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, -0.5)))
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, -1.)))
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.71, radius2=1.71, depth=0.01)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, 1.)))
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, 1.)))
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.71, radius2=1.71, depth=0.01)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, -1.)))
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, -1.5)))
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.29, radius2=1.29, depth=0.01)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, 1.5)))
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, 1.5)))
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=40, radius1=1.29, radius2=1.29, depth=0.01)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, -1.5)))
    ...
    bm = bmesh.new()
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=20, radius1=0.1, radius2=0., depth=0.2)
    bmesh.ops.translate(bm, verts = bm.verts, vec = Vector((0.0, 0.0, 1.)))
    bmesh.ops.create_cone(bm, cap_ends=False, cap_tris=False, segments=20, radius1=0.05, radius2=0.05, depth=1.9)
