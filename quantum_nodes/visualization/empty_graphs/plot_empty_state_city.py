...
def plotEmptyStateCity():      
    ...
    historamCityDrawAxes(mesh_axes_vertical_front, nb_cubes, T, T, X, 0.0, (Y-0.5)/nb_cubes, 0.0, -Y+0.51, -0.5, X/2)
    ...
    historamCityDrawAxes(mesh_axes_bottom_vertical, nb_cubes, Y, T, T, 0.0, (Y-0.5)/nb_cubes, 0.0, -Y/2+0.5,-0.5, T)
