...
class QuantumGateCCYNode(bpy.types.Node, AnimationNode):
    bl_idname = "an_QuantumGateCCYToAllNode"
    bl_label = "Quantum Gate CCY To All Circuit"
    ...
    def execute(self, input ,controle_qubit_1,controle_qubit_2 ,target_qubit ):
        try:
            input.ccy(controle_qubit_1, controle_qubit_2,target_qubit)
            return input
        except:
            return